package com.walmartlabs.ern.damysminiapp;

import com.walmartlabs.ern.container.miniapps.DamysMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = DamysMiniappActivity.class;
